...
class MyDialogWindow extends JDialog {
	...
	private void initGUI() {
		...
		mainPanel.add(Box.createRigidArea(new Dimension(0, 20))); //Para poner un espacio
	...
	//En nuestra práctica tendremos que pasar el RoadMap.
...
/*
 * Para la ventanade diálogo debes 
 * implementarla clase ChangeCO2ClassDialog que extiendea JDialog.
 * 
 * (Este ejemplo de aqui nos sirve para poder hacerlo)
 * 
 * clase ChangeCO2ClassDialog será una clase del paquete de view
 * 
 * */
